...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
    multiply([2,3]).should == 2*3
  end

  it "multiplies several numbers" do
    multiply([2,3,4]).should == 2*3*4
  end
...
describe "#factorial" do
  ...
  it "doesn't compute the factorial of an non integer" do
    factorial(3.4).should == nil
  end
  it "doesn't compute the factorial of a negative" do
    factorial(-5.6).should == nil
  end
end
